...
public class FConstants {
    static {
        ...
        FollowerConstants.translationalPIDFCoefficients.setCoefficients(0.05,0.0005,0,0);
        ...
        FollowerConstants.drivePIDFCoefficients.setCoefficients(0.025,0,0,0.6,0);
